...
KNOWLEDGE_CASES = [
    ...
    GoldenTestCase("k017", "knowledge", "作品简介",
        [GoldenTurn("《三体》讲的是什么？", expected_track="knowledge", expected_intent="album_content_detail")]),
    GoldenTestCase("k018", "knowledge", "演播者信息",
        [GoldenTurn("这本书是谁播讲的？", expected_track="clarify")]),
    GoldenTestCase("k019", "knowledge", "作品评分",
        [GoldenTurn("《诡秘之主》评分多少？", expected_track="knowledge", expected_intent="album_content_detail")]),
    ...
    GoldenTestCase("k021", "knowledge", "完结状态",
        [GoldenTurn("《剑来》完结了吗？", expected_track="knowledge", expected_intent="album_content_detail")]),
...
EDGE_CASES = [
    ...
    GoldenTestCase("e007", "edge_case", "emoji",
        [GoldenTurn("😊😊😊", expected_track="chitchat")]),
    ...
    GoldenTestCase("e013", "edge_case", "重复字符",
        [GoldenTurn("啊啊啊啊啊啊啊啊", expected_track="chitchat")]),
